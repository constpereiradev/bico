                ...
                <DialogContent>
                    <form class="space-y-6" @submit="deleteUser">
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                                Após a exclusão da sua conta, todos os seus recursos e dados também serão excluídos
                                permanentemente. Insira sua
                                senha para confirmar que deseja excluir sua conta permanentemente.
                            </DialogDescription>
                        </DialogHeader>
                        ...
                        <DialogFooter class="gap-2">
                            ...
                            <Button type="submit" variant="destructive" :disabled="form.processing"> Deletar conta
                            </Button>
                        </DialogFooter>
                    </form>
                </DialogContent>
